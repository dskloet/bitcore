...
Transaction.prototype.getSerializationError = function(opts) {
  ...
  if (this._getUnspentValue() < 0) {
    unspentError = this._hasMoreOutputThanInput(opts);
  } else {
    unspentError = this._hasFeeError(opts);
  }
...
Transaction.prototype._hasFeeError = function(opts) {
  ...
  if (!_.isUndefined(this._fee) && this._fee !== fee) {
    return new errors.Transaction.FeeError.Different('Unspent value is ' + fee + ' but specified fee is ' + this._fee);
  }
